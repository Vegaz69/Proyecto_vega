...
<button onclick="window.scrollTo({top: 0, behavior: 'smooth'});"
    class="btn btn-warning rounded-circle shadow back-to-top" type="button" aria-label="Ir arriba">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-dark text-white">
                <h5 class="modal-title" id="loginRegisterModalLabel"><i class="fas fa-user-circle me-2"></i> Acceso
                    Requerido</h5>
            ...
            <div class="modal-footer justify-content-center">
                <a href="<?= base_url('login') ?>" class="btn btn-dark btn-lg me-3"><i
                        class="fas fa-sign-in-alt me-2"></i> Iniciar Sesión</a>

                <a href="<?= base_url('registro') ?>" class="btn btn-outline-dark btn-lg"><i
                        class="fas fa-user-plus me-2"></i> Registrarse</a>
=======
    ...
    <div class="modal fade" id="loginRegisterModal" tabindex="-1" aria-labelledby="loginRegisterModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-dark text-white">
                    <h5 class="modal-title"><i class="fas fa-user-circle me-2"></i> Acceso Requerido</h5>
