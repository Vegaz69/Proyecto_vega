...
<div id="mainCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?= base_url('assets/img/ryzen1.avif') ?>" class="d-block w-100 img-fluid"
                alt="Procesadores Ryzen">
            <div class="carousel-caption d-none d-md-block text-start">
                <h5 class="display-4 fw-bold text-white shadow-text">Potencia sin Límites</h5>
                <p class="lead text-white shadow-text">Descubre la nueva generación de rendimiento para gaming y
                    creación de contenido.</p>
                <a href="<?= base_url('catalogo') ?>" class="btn btn-primary btn-lg mt-3 rounded-pill">Ver Productos <i
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block text-center">
                ...
                <p class="lead text-white shadow-text">Sumérgete en mundos virtuales con una fluidez y detalle
                    asombrosos.</p>
                <a href="<?= base_url('catalogo') ?>" class="btn btn-warning btn-lg mt-3 rounded-pill">Explorar GPU <i
                        class="fas fa-arrow-right ms-2"></i></a>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block text-end">
                ...
                <p class="lead text-white shadow-text">Todo lo que necesitas para armar la PC gamer o profesional
                    perfecta.</p>
                <a href="<?= base_url('catalogo') ?>" class="btn btn-info btn-lg mt-3 rounded-pill">Comenzar Ahora <i
                        class="fas fa-arrow-right ms-2"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col">
            <div class="card h-100 border-0 shadow-lg transform-on-hover">
                <img src="<?= base_url('assets/img/pin/pin1.jfif') ?>" class="card-img-top img-fluid rounded-top"
                    alt="Procesadores AMD Ryzen">
                <div class="card-body">
                    <h5 class="card-title text-center text-primary fs-4 fw-bold">Potencia sin límites con Ryzen!</h5>
                    <p class="card-text text-justify text-muted">Descubre el rendimiento extremo de los procesadores AMD
                        Ryzen, diseñados para llevar tu creatividad, productividad y gaming al siguiente nivel. Más
                        núcleos, más velocidad, más eficiencia.</p>
                </div>
        ...
        <div class="col">
            <div class="card h-100 border-0 shadow-lg transform-on-hover">
                <img src="<?= base_url('assets/img/pin/pin5.jfif') ?>" class="card-img-top img-fluid rounded-top"
                    alt="Productos MSI">
                <div class="card-body">
                    <h5 class="card-title text-center text-success fs-4 fw-bold">Rendimiento sin límites con MSI!</h5>
                    <p class="card-text text-justify text-muted">Potencia, innovación y diseño se combinan en los
                        productos MSI, creados para los gamers más exigentes y los profesionales que buscan lo mejor en
                        hardware. Máxima velocidad, refrigeración avanzada y tecnología de vanguardia.</p>
                </div>
                <div class="card-footer bg-transparent border-top-0 text-center">
                    <small class="text-muted">Actualizado recientemente</small>
                </div>
        ...
        <div class="col">
            <div class="card h-100 border-0 shadow-lg transform-on-hover">
                <img src="<?= base_url('assets/img/pin/pin3.jfif') ?>" class="card-img-top img-fluid rounded-top"
                    alt="Productos AORUS">
                <div class="card-body">
                    <h5 class="card-title text-center text-warning fs-4 fw-bold">AORUS: La excelencia en rendimiento.
                    </h5>
                    <p class="card-text text-justify text-muted">Lleva tu experiencia al límite con AORUS, la marca
                        líder en hardware de alto desempeño para gamers y creadores. Potencia inigualable, refrigeración
                        avanzada y tecnología de vanguardia para que domines cada partida.</p>
                </div>
                <div class="card-footer bg-transparent border-top-0 text-center">
                    <small class="text-muted">Actualizado recientemente</small>
                </div>
...
<div class="container my-2 py-2 bg-white text-dark rounded shadow-sm">
        ...
        <div class="col-6 col-md-3 col-lg-2">
            <div class="d-block text-decoration-none p-1 p-md-3 hover-lift rounded border"
                ...
                <i class="<?= esc($cat['icon_class']) ?> category-icon mb-2"
                    style="color: <?= esc($cat['color']) ?>; font-size: 3rem;"></i>
                <p class="small fw-medium text-dark mb-0 mt-1 fs-md-6">
                    <?= esc($cat['name']) ?>
                </p>
            </div>
        </div>
    ...
    <div class="text-center mt-3 mt-md-3">
        <a href="<?= base_url('catalogo') ?>"
            class="btn btn-sm btn-md-lg btn-outline-primary rounded-pill px-4 px-md-5">
