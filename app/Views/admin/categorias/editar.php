...
<h2 class="mb-4 text-center fw-bold"><i class="fas fa-tags me-2"></i> Editar Categoría: <?= esc($categoria['nombre']) ?></h2>

<div class="row justify-content-center">
    <div class="col-12 col-md-8 col-lg-6"> <div class="card shadow-sm mb-4">
            <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                <h5 class="card-title text-white mb-0">Detalles de la Categoría</h5>
