...
<div class="container-fluid">
    ...
    <div class="row mb-5 g-4"> <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="p-4 bg-primary text-white rounded shadow-sm d-flex justify-content-between align-items-center h-100">
                <div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="p-4 bg-success text-white rounded shadow-sm d-flex justify-content-between align-items-center h-100">
                <div>
        ...
        <div class="col-lg-4 col-md-12 col-sm-12">
            <div class="p-4 bg-warning text-dark rounded shadow-sm d-flex justify-content-between align-items-center h-100">
                <div>
    ...
    <div class="row mb-5 g-4 justify-content-center">
        <div class="col-lg-3 col-md-6 col-sm-12">
            <a href="<?= base_url('admin/productos/crear') ?>" class="card text-center p-3 shadow-sm h-100 d-block text-decoration-none text-dark hover-effect">
                <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            <a href="<?= base_url('admin/categorias/crear') ?>" class="card text-center p-3 shadow-sm h-100 d-block text-decoration-none text-dark hover-effect">
                <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            <a href="<?= base_url('admin/usuarios/crear') ?>" class="card text-center p-3 shadow-sm h-100 d-block text-decoration-none text-dark hover-effect">
                <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            <a href="<?= base_url('admin/mensajes') ?>" class="card text-center p-3 shadow-sm h-100 d-block text-decoration-none text-dark hover-effect">
                <div class="card-body">
                    <i class="fas fa-envelope fa-3x mb-3 text-danger"></i>
                    <h5 class="card-title fw-bold">Mensajes (0)</h5> <p class="card-text text-muted">Revisa consultas de clientes.</p>
                </div>
            </a>
        </div>
    </div>
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= base_url('admin/usuarios') ?>" class="badge bg-secondary text-decoration-none">Ver</a>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                            ...
                            <a href="<?= base_url('admin/productos') ?>" class="badge bg-success text-decoration-none">Editar</a>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= base_url('admin/categorias') ?>" class="badge bg-warning text-decoration-none">Detalle</a>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <i class="fas fa-box-open text-secondary me-2"></i> Stock bajo: <strong class="text-dark">Producto Z (5 unidades)</strong>
                                <small class="text-muted d-block">Ayer</small>
                            </div>
                            <a href="<?= base_url('admin/productos') ?>" class="badge bg-danger text-decoration-none">Atender</a>
                        </li>
                    </ul>
                </div>
            </div>
