...
<h2 class="mb-4 text-center fw-bold"><i class="fas fa-boxes me-2"></i> Editar Producto:
    <?= esc($producto['nombre'] ?? 'Cargando...') ?>
</h2>
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('admin/productos/guardar') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id_producto"
                        value="<?= esc($oldInput['id_producto'] ?? $producto['id_producto'] ?? '') ?>">
                    <!-- Campo oculto para la imagen actual -->
                    <input type="hidden" name="imagen_actual"
                        value="<?= esc($oldInput['imagen'] ?? $producto['imagen'] ?? '') ?>">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="nombre" value="<?= esc($oldInput['nombre'] ?? $producto['nombre'] ?? '') ?>"
                                    required minlength="3" maxlength="100" autocomplete="product-name">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="marca" value="<?= esc($oldInput['marca'] ?? $producto['marca'] ?? '') ?>"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01"
                                    ...
                                    name="precio" value="<?= esc($oldInput['precio'] ?? $producto['precio'] ?? '') ?>"
                                    required min="0.01">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?= session('errors.descripcion') ? 'is-invalid' : '' ?>"
                            ...
                            maxlength="65535"><?= esc($oldInput['descripcion'] ?? $producto['descripcion'] ?? '') ?></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control <?= session('errors.imagen_file') ? 'is-invalid' : '' ?>"
                            id="imagen_file" name="imagen_file" accept="image/*">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number"
                                    ...
                                    name="stock" value="<?= esc($oldInput['stock'] ?? $producto['stock'] ?? '') ?>"
                                    required min="0">
                        ...
                        <div class="col-md-6 d-flex align-items-center mt-3 mt-md-0">
                            <div class="form-check">
                                <input type="checkbox"
                                    ...
                                    ($oldInput['activo']==1 ? 'checked' : '' ) : (isset($producto['activo']) &&
