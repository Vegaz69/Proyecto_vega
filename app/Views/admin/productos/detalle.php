    ...
    <div class="row">
        <div class="col-md-6 mb-4">
            ...
            <img src="<?= base_url('uploads/productos/' . esc($producto['imagen'])) ?>"
                class="img-fluid rounded shadow-sm" alt="<?= esc($producto['nombre']) ?>">
            <?php else: ?>
            <img src="<?= base_url('assets/img/placeholder.png') ?>" class="img-fluid rounded shadow-sm"
        ...
        <div class="col-md-6 mb-4">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <span id="product-stock-badge" class="badge bg-success fs-5">
                    <?= esc($producto['stock']) ?> en stock
                </span>
            ...
            <form id="addToCartForm" action="<?= base_url('carrito/agregar') ?>" method="post" class="mb-4">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <input type="number" id="cantidad" name="cantidad" class="form-control" value="1" min="1"
                        max="<?= esc($producto['stock']) ?>" style="width: 80px;">
                </div>
    ...
    <div class="container my-3">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <h4 class="mb-2 text-danger border-bottom border-danger pb-1">
                    <?= esc($sectionTitle) ?>
                </h4>
                <div class="ms-2">
                    <?php
                    ...
                    <div class="d-flex justify-content-between align-items-baseline py-1">
                        ...
                        <span class="text-dark text-end flex-grow-1">
                            <?= esc($value) ?>
                        </span>
                    </div>
                    <?php
