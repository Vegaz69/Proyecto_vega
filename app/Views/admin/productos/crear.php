            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('admin/productos/guardar') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= session('errors.nombre') ? 'is-invalid' : '' ?>" id="nombre" name="nombre" value="<?= esc($oldInput['nombre'] ?? '') ?>" required minlength="3" maxlength="100" autocomplete="product-name">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= session('errors.marca') ? 'is-invalid' : '' ?>" id="marca" name="marca" value="<?= esc($oldInput['marca'] ?? '') ?>" required minlength="2" maxlength="100" autocomplete="organization">
                    ...
                    <div class="row">
                                ...
                                <select class="form-select <?= session('errors.id_categoria') ? 'is-invalid' : '' ?>" id="id_categoria" name="id_categoria" required>
                                    ...
                                    <?php if (!empty($categorias)) : ?>
                                        <?php foreach ($categorias as $categoria) : ?>
                                            <option value="<?= esc($categoria['id_categoria']) ?>" <?= (isset($oldInput['id_categoria']) && $oldInput['id_categoria'] == $categoria['id_categoria']) ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control <?= session('errors.precio') ? 'is-invalid' : '' ?>" id="precio" name="precio" value="<?= esc($oldInput['precio'] ?? '') ?>" required min="0.01">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?= session('errors.descripcion') ? 'is-invalid' : '' ?>" id="descripcion" name="descripcion" rows="4" maxlength="65535"><?= esc($oldInput['descripcion'] ?? '') ?></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control <?= session('errors.imagen_file') ? 'is-invalid' : '' ?>" id="imagen_file" name="imagen_file" accept="image/*" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control <?= session('errors.stock') ? 'is-invalid' : '' ?>" id="stock" name="stock" value="<?= esc($oldInput['stock'] ?? '') ?>" required min="0">
                        ...
                        <div class="col-md-6 d-flex align-items-center mt-3 mt-md-0">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input <?= session('errors.activo') ? 'is-invalid' : '' ?>" id="activo" name="activo" value="1" <?= (isset($oldInput['activo']) ? ($oldInput['activo'] == 1 ? 'checked' : '') : 'checked') ?>>
