            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('admin/productos/guardar') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descripcion_producto" name="descripcion" rows="4"><?= old('descripcion') ?></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="imagen_producto" name="imagen_file" accept="image/*" required> <div class="form-text">Sube una imagen para el producto (JPG, PNG, GIF, etc.).</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex align-items-center mt-3 mt-md-0">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="activo_producto" name="activo" value="1" <?= (old('activo') === null || old('activo') == 1) ? 'checked' : '' ?>>
