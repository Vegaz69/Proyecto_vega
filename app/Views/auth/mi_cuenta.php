        ...
        <div class="col-md-10 col-lg-8">
            <div class="card shadow-lg p-4 rounded-3">
                <ul class="nav nav-tabs mb-4" id="myAccountTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="email-pass-tab" data-bs-toggle="tab" data-bs-target="#email-pass" type="button" role="tab" aria-controls="email-pass" aria-selected="false">
                ...
                <div class="tab-content" id="myAccountTabContent">
                    <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                        ...
                        <div class="mb-3">
                            <label for="nombre_display" class="form-label">Nombre</label>
                            <input type="text" class="form-control" id="nombre_display" value="<?= esc($usuario['nombre']) ?>" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="apellido_display" class="form-label">Apellido</label>
                            <input type="text" class="form-control" id="apellido_display" value="<?= esc($usuario['apellido']) ?>" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="email_display" class="form-label">Correo Electrónico</label>
                            <input type="email" class="form-control" id="email_display" value="<?= esc($usuario['email']) ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="email-pass" role="tabpanel" aria-labelledby="email-pass-tab">
                        ...
                        <form action="<?= base_url('mi-cuenta/actualizar'); ?>" method="post">
                            ...
                            <h5 class="mb-3 text-primary"><i class="fas fa-envelope me-2"></i>Cambiar Correo Electrónico</h5>
                            <div class="mb-3">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="password" class="form-control" id="email_current_password" name="email_current_password" placeholder="Verifica tu contraseña actual" autocomplete="off">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Repetir nueva contraseña" autocomplete="new-password">
                            </div>
