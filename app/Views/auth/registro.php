                ...
                <div class="card-body p-4">
                    ...
                    <form action="<?= base_url('registro') ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" id="nombre" class="form-control form-control-lg" required value="<?= old('nombre') ?>" placeholder="Tu nombre">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="apellido" id="apellido" class="form-control form-control-lg" required value="<?= old('apellido') ?>" placeholder="Tu apellido">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control form-control-lg" required value="<?= old('email') ?>" placeholder="Tu correo electrónico">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" id="password" class="form-control form-control-lg" required minlength="6" placeholder="Tu contraseña">
                        ...
                        <div class="mb-3">
                            <label for="confirm_password" class="form-label"><i class="fas fa-redo me-2"></i> Repetir contraseña</label>
                            <input type="password" name="confirm_password" id="confirm_password" class="form-control form-control-lg" required minlength="6" placeholder="Repite tu contraseña">
                            <div id="passwordFeedback" class="form-text d-none">Las contraseñas no coinciden</div>
                            <?php if (session('errors.confirm_password')) : ?>
                                <p class="text-danger"><?= session('errors.confirm_password') ?></p>
                            <?php endif ?>
                        </div>
