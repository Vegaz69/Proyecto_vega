<div class="container my-4">
    <h2 class="mb-4">Resultados de búsqueda para: "
        <?= esc($searchTerm ?? '') ?>"
    </h2>
            ...
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <p class="card-text text-muted small">
                        <?= esc($producto['marca'] ?? 'Marca Desconocida') ?>
                    </p>
                    <p class="card-text text-muted small">Categoría:
                        <?= esc($producto['categoria_nombre'] ?? 'Sin Categoría') ?>
                    </p>
                    <p class="card-text fw-bold mt-auto">$
                        <?= number_format($producto['precio'], 2, ',', '.') ?>
                    </p>
                    <a href="<?= base_url('producto/' . $producto['id_producto']) ?>" class="btn btn-primary mt-2">Ver
                        Detalle</a>
                </div>
            </div>
        </div>
